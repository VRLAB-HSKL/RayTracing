...
public class RayTracerTests : MonoBehaviour
{
    ...
    {
        Color actualColor = RayTracerUnity.CreateNonHitColor(Vector3.zero);
    ...
    public void Check_Reflection_Vector()
    {
        ...
        Vector3 actualVector = RayTracerUnity.Reflect(testV, testN);
    ...
    public void Check_Refraction_Vector()
    {
        ...
        RayTracerUnity.Refract(testV, testN, ni_nt, out actualRefraction);
    ...
    public void Check_Schlick()
    {
        float cosine = 1f;
        float ref_idx = 1.5f;
        float actualResult = RayTracerUnity.Schlick(cosine, ref_idx);
